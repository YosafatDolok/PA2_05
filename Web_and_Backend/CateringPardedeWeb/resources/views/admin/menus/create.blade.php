        ...
        <div class="col-xl-8 col-lg-10 mx-auto">
            <div class="card aura-card shadow-lg">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="m-0 font-weight-bold">Tambah Menu Baru</h4>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="misal: Nasi Goreng" value="{{ old('name') }}">
                                    @error('name')
                            ...
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" placeholder="Masukkan detail masakan...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div class="d-flex align-items-center gap-4 mt-2">
                                        <div class="aura-upload-zone" style="width: 120px; min-height: 120px; border-radius: 15px;">
                                            ...
                                            <img id="previewImage" src="#" alt="Preview" class="aura-upload-preview" style="display: none;">
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        ...
                                        <label class="form-check-label ms-3 text-muted fw-bold" for="availableSwitch">TERSEDIA</label>
                                    </div>
                                </div>
                            </div>
